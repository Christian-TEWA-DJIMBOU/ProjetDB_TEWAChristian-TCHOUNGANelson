...
-- 5. emploiyé  (attention : nom de table avec accent tel que fourni)
INSERT INTO emploiye (e_id, e_nom, e_prenom, e_mail, e_age, ad_adresse, a_nom) VALUES
(1, 'Dupont', 'Jean',   'jean.dupont@example.com',   34, 'addr1',  'AgenceParis'),
(2, 'Martin', 'Sophie', 'sophie.martin@example.com',29, 'addr2',  'AgenceLyon'),
(3, 'Bernard','Luc',    'luc.bernard@example.com',  41, 'addr3',  'AgenceMarseille'),
(4, 'Petit',  'Claire', 'claire.petit@example.com', 30, 'addr4',  'AgenceParis'),
(5, 'Morel',  'Antoine','antoine.morel@example.com',38, 'addr5',  'AgenceLyon'),
(6, 'Roux',   'Lea',    'lea.roux@example.com',     27, 'addr6',  'AgenceMarseille');

-- 6. clients
INSERT INTO clients (cl_id, cl_nom, cl_prenom, cl_date, cl_age, cl_email, ad_adresse, e_id) VALUES
(1,  'Durand', 'Alice',  '2023-03-12', 28, 'alice.durand@example.com',  'addr1', 1),
(2,  'Moreau', 'Paul',   '2022-11-20', 40, 'paul.moreau@example.com',   'addr2', 2),
(3,  'Leroy',  'Marie',  '2024-01-15', 33, 'marie.leroy@example.com',   'addr3', 3),
(4,  'Faure',  'Nicolas','2023-05-30', 45, 'nicolas.faure@example.com', 'addr4', 1),
(5,  'Gautier','Emma',   '2022-09-08', 25, 'emma.gautier@example.com',  'addr5', 2),
(6,  'Blanc',  'Hugo',   '2024-02-10', 31, 'hugo.blanc@example.com',    'addr6', 4),
(7,  'Perrin', 'Camille','2023-07-21', 36, 'camille.perrin@example.com','addr7', 5),
(8,  'Robin',  'Thomas', '2024-03-01', 29, 'thomas.robin@example.com',  'addr8', 6),
(9,  'Giraud', 'Laura',  '2023-08-12', 27, 'laura.giraud@example.com',  'addr9', 3),
(10, 'Dupuis', 'Marc',   '2022-12-05', 50, 'marc.dupuis@example.com',   'addr10',2);

-- 7. contrats (remarque : colonne accentuée 'co_etat_départ' utilisée telle quelle)
